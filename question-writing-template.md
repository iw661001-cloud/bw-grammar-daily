...
|---|---|---|---|---|---|
| junior-vocab | 國中單字 | mc | 國中 | 200題（目標字見下方清單） | jv-236 開始 |

**這次額外要求**：
- 目標字清單（200字，教育部2000字表下一段，已排除現有235題用過的字）：`D:\Users\bw5418\projects\english-study\00-自學\_drafts\junior-vocab-batch3-words.txt`
- 沿用上一批已確認可行的規則：字太簡單/難設計誘答選項時，改用片語搭配或拼字形近詞干擾選項
- 分批交回，每批50題，累加寫入`_drafts\junior-vocab.json`
